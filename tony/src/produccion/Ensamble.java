 ...
 */
public class Ensamble extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        Inventario.setBackground(new java.awt.Color(123, 104, 238));
        Inventario.setFont(new java.awt.Font("Arial", 0, 11)); // NOI18N
        Inventario.setForeground(new java.awt.Color(255, 255, 255));
        Inventario.setText("Ver en inventario");
        ...
        jLabel4.setText("SISTEMA OPERATIVO: Windows 10 Versión");

        jLabel5.setFont(new java.awt.Font("Arial", 0, 12)); // NOI18N
        jLabel5.setText("CPU: AMD Ryzen 7 4700");

        jLabel6.setFont(new java.awt.Font("Arial", 0, 12)); // NOI18N
        jLabel6.setText("RAM: 16GB a 3200 MHz");

        jLabel7.setFont(new java.awt.Font("Arial", 0, 12)); // NOI18N
        jLabel7.setText("SSD: 240 GB");

        jLabel8.setFont(new java.awt.Font("Arial", 0, 12)); // NOI18N
        jLabel8.setText("DD: 3TB");

        jLabel9.setFont(new java.awt.Font("Arial", 0, 12)); // NOI18N
        jLabel9.setText("Fuente de Poder: 600W 80 plus GOLD");

        jLabel10.setFont(new java.awt.Font("Arial", 0, 12)); // NOI18N
        jLabel10.setText("Gabinete: Ventana de Cristal templado y RGB");

        jLabel11.setFont(new java.awt.Font("Arial", 0, 12)); // NOI18N
        jLabel11.setText("Tarjeta gráfica dedicada AMD Radeon RX 550");

        regresar1.setBackground(new java.awt.Color(123, 104, 238));
        regresar1.setFont(new java.awt.Font("Arial", 0, 11)); // NOI18N
        ...
        jPanel1Layout.setHorizontalGroup(
            ...
            .addGroup(jPanel1Layout.createSequentialGroup()
                ...
                .addGap(121, 239, Short.MAX_VALUE)
        ...
        jPanel1Layout.setVerticalGroup(
            ...
            .addGroup(jPanel1Layout.createSequentialGroup()
                ...
                .addGroup(jPanel1Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.BASELINE)
                    .addComponent(Inventario, javax.swing.GroupLayout.PREFERRED_SIZE, 23, javax.swing.GroupLayout.PREFERRED_SIZE)
                    .addComponent(regresar1))
                .addGap(41, 41, 41))
        );

        jTabbedPane1.addTab("PC GAMER", jPanel1);

        jPanel4.setBackground(new java.awt.Color(255, 255, 255));

        Inventario2.setBackground(new java.awt.Color(123, 104, 238));
        Inventario2.setForeground(new java.awt.Color(255, 255, 255));
        Inventario2.setText("Ver en inventario");
        ...
        Regresar.setFont(new java.awt.Font("Arial", 0, 11)); // NOI18N
        ...
        jLabel23.setText(" Sistema operativo Windows 10 Home 64");

        jLabel24.setFont(new java.awt.Font("Arial", 0, 12)); // NOI18N
        jLabel24.setText("Procesador Intel Core i7-10750H");

        jLabel25.setFont(new java.awt.Font("Arial", 0, 12)); // NOI18N
        jLabel25.setText("Memoria 16 GB de SDRAM DDR4-2933 (2 x 8 GB)");

        jLabel26.setFont(new java.awt.Font("Arial", 0, 12)); // NOI18N
        jLabel26.setText("Almacenamiento interno SSD Intel de 512 GB");

        jLabel27.setFont(new java.awt.Font("Arial", 0, 12)); // NOI18N
        jLabel27.setText("Graphics (integrated) Gráficos Intel UHD");

        jLabel28.setFont(new java.awt.Font("Arial", 0, 12)); // NOI18N
        jLabel28.setText("Cámara Web Cámara HD HP Wide Visionl");

        jLabel33.setFont(new java.awt.Font("Arial", 0, 18)); // NOI18N
        jLabel33.setText("ENSAMBLE");
        ...
        jTabbedPane1.addTab("LAPTOP", jPanel4);

        jPanel5.setBackground(new java.awt.Color(255, 255, 255));

        Inventario5.setBackground(new java.awt.Color(123, 104, 238));
        Inventario5.setForeground(new java.awt.Color(255, 255, 255));
        Inventario5.setText("Ver en inventario");
        Inventario5.addActionListener(new java.awt.event.ActionListener() {
            public void actionPerformed(java.awt.event.ActionEvent evt) {
                Inventario5ActionPerformed(evt);
            }
        });

        Regresar3.setBackground(new java.awt.Color(123, 104, 238));
        Regresar3.setFont(new java.awt.Font("Arial", 0, 11)); // NOI18N
        ...
        jLabel34.setText("CREACION DE SOFTWARE");

        jLabel35.setFont(new java.awt.Font("Arial", 0, 12)); // NOI18N
        jLabel35.setText("Creación de página web ");

        jLabel36.setFont(new java.awt.Font("Arial", 0, 12)); // NOI18N
        jLabel36.setText("Creación de aplicaciones móviles (androit / apple) ");

        jLabel37.setFont(new java.awt.Font("Arial", 0, 12)); // NOI18N
        jLabel37.setText("Creación de software empresariales ");
        ...
        jTabbedPane1.addTab("SOFTWARE", jPanel5);

        jPanel3.setBackground(new java.awt.Color(255, 255, 255));

        inventario1.setBackground(new java.awt.Color(123, 104, 238));
        inventario1.setFont(new java.awt.Font("Arial", 0, 11)); // NOI18N
        inventario1.setForeground(new java.awt.Color(255, 255, 255));
        inventario1.setText("Ver en inventario");
        ...
        regresar2.setBackground(new java.awt.Color(123, 104, 238));
        regresar2.setFont(new java.awt.Font("Arial", 0, 11)); // NOI18N
        ...
        jLabel14.setText("Es monocromática");

        jLabel15.setFont(new java.awt.Font("Arial", 0, 12)); // NOI18N
        jLabel15.setText("Imprime, escanea y hace copias.");

        jLabel16.setFont(new java.awt.Font("Arial", 0, 12)); // NOI18N
        jLabel16.setText("Impresión doble faz automática.");

        jLabel17.setFont(new java.awt.Font("Arial", 0, 12)); // NOI18N
        jLabel17.setText("Tecnología de impresión: láser.");

        jLabel18.setFont(new java.awt.Font("Arial", 0, 12)); // NOI18N
        jLabel18.setText("Tiene entrada USB.");

        jLabel19.setFont(new java.awt.Font("Arial", 0, 12)); // NOI18N
        jLabel19.setText("Capacidad máxima de 350 hojas.");

        jLabel30.setFont(new java.awt.Font("Arial", 0, 18)); // NOI18N
        jLabel30.setText("ENSAMBLE");
        ...
        getContentPane().add(jTabbedPane1, new org.netbeans.lib.awtextra.AbsoluteConstraints(20, 11, 560, 370));
...
ob.setVisible(true);
    ...
    private void Inventario5ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_Inventario5ActionPerformed
   Inventario ob=new Inventario();
        ob.setVisible(true);
        dispose();     // TODO add your handling code here:
    }//GEN-LAST:event_Inventario5ActionPerformed
...
ob.setVisible(true);
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(Ensamble.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        //</editor-fold>inventario1  /* Create and display the form */
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new Ensamble().setVisible(true);
            }
        });
    }
