...
public class almacen1 extends javax.swing.JFrame {
    ...
    menucompras venCompras = new menucompras();
    ...
    private void initComponents() {
        ...
        jPanel1.setBorder(javax.swing.BorderFactory.createLineBorder(new java.awt.Color(5, 240, 122)));
        jPanel1.setForeground(new java.awt.Color(5, 240, 122));

        jTextField1.setEditable(false);
        jTextField1.setBackground(new java.awt.Color(5, 240, 122));
        jTextField1.setFont(new java.awt.Font("Arial", 0, 24)); // NOI18N
        jTextField1.setText("  ALMACEN TONY");
        ...
        jButton1.setText("EMITIR MATERIAL");
        ...
        jButton2.setText("EXISTENCIA CON LOTES");
        ...
        jButton3.setText("EMITIR MATERIAL MICELANEO");
        ...
        jButton4.setText("INGRESO DE RECEPCIONES");
        ...
        jButton5.setText("INGRESO DE EMBARQUE PARA EL CLIENTE");
...
emitir_material ob=new emitir_material();
ob.setVisible (true);
dispose();
...
existencia_lotes ob=new existencia_lotes();
ob.setVisible (true);
dispose();
        // TODO add your handling code here:
...
emitir_material_micelaneo ob=new emitir_material_micelaneo();
ob.setVisible (true);
dispose();
        // TODO add your handling code here:
...
dispose();
  ...
  embarque_cliente ob=new embarque_cliente();
ob.setVisible (true);
